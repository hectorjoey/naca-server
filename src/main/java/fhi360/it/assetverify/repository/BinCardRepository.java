...
public interface BinCardRepository extends JpaRepository<BinCard, Long> {
    ...
    @Query("Select b from BinCard b where b.warehouseName=:keyword OR b.batchNo=:keyword OR b.itemDescription=:keyboard OR b.dispatchedLocation =: keyword OR b.issuedTo =: keyword OR b.issuedToEmail=:keyword OR b.phone=:keyword")
